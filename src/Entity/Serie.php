...
class Serie
{
    ...
    #[Assert\Choice(choices: ['returning', 'ended', 'Canceled'], message: 'Invalid status!')]
    #[ORM\Column(length: 50)]
    private ?string $status = null;

    #[Assert\Range(notInRangeMessage: 'The vote must be between 0 and 10!', min: 0, max: 10)]
    ...
    #[Assert\Assert\GreaterThanOrEqual(propertyPath: 'firstAirDate', message: 'The last air date must be after the first air date!')]
    #[ORM\Column(type: Types::DATE_MUTABLE)]
